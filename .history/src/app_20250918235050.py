...
try:
    ...
    # Fallback in case LANGUAGE_NAMES is not available
...
with st.sidebar:
    ...
    selected_language = st.selectbox(
        ...
        index=list(LANGUAGE_NAMES.keys()).index(st.session_state.language) if st.session_state.language in LANGUAGE_NAMES else 0
    )
